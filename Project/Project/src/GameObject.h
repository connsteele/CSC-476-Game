...
public:
	...
	bool hitByPlayer, visibleBbox, isPosessed, isRender, beenShot, isHealthTile, isGroundTile, isUpperTile, isCoverTile, isJumpTile, isUpperCoverTile, isBoundingTile, isStaticGeom, isCulled;
